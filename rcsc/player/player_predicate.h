...
public:
    ...
    */
    ...
    //! pointer type
    typedef boost::shared_ptr< const PlayerPredicate > Ptr;
};
...
private:
    ...
    std::vector< PlayerPredicate::Ptr > M_predicates;
...
public:
    ...
    */
    AndPlayerPredicate( const PlayerPredicate * p1 ,
        ...
        : M_predicates()
      {
          M_predicates.push_back( PlayerPredicate::Ptr( p1 ) );
          M_predicates.push_back( PlayerPredicate::Ptr( p2 ) );
      }
    ...
    */
    AndPlayerPredicate( const PlayerPredicate * p1 ,
        ...
        : M_predicates()
      {
          M_predicates.push_back( PlayerPredicate::Ptr( p1 ) );
          M_predicates.push_back( PlayerPredicate::Ptr( p2 ) );
          M_predicates.push_back( PlayerPredicate::Ptr( p3 ) );
      }
    ...
    */
    AndPlayerPredicate( const PlayerPredicate * p1 ,
        ...
        : M_predicates()
      {
          ...
          M_predicates.push_back( PlayerPredicate::Ptr( p2 ) );
          M_predicates.push_back( PlayerPredicate::Ptr( p3 ) );
          M_predicates.push_back( PlayerPredicate::Ptr( p4 ) );
      }
    ...
    */
    AndPlayerPredicate( const PlayerPredicate * p1 ,
        ...
        : M_predicates()
      {
          ...
          M_predicates.push_back( PlayerPredicate::Ptr( p3 ) );
          M_predicates.push_back( PlayerPredicate::Ptr( p4 ) );
          M_predicates.push_back( PlayerPredicate::Ptr( p5 ) );
      }
    ...
    */
    AndPlayerPredicate( const PlayerPredicate * p1 ,
        ...
        : M_predicates()
      {
          ...
          M_predicates.push_back( PlayerPredicate::Ptr( p4 ) );
          M_predicates.push_back( PlayerPredicate::Ptr( p5 ) );
          M_predicates.push_back( PlayerPredicate::Ptr( p6 ) );
      }
    ...
    */
    AndPlayerPredicate( const PlayerPredicate * p1 ,
        ...
        : M_predicates()
      {
          ...
          M_predicates.push_back( PlayerPredicate::Ptr( p5 ) );
          M_predicates.push_back( PlayerPredicate::Ptr( p6 ) );
          M_predicates.push_back( PlayerPredicate::Ptr( p7 ) );
      }
    ...
    */
    AndPlayerPredicate( const PlayerPredicate * p1 ,
        ...
        : M_predicates()
      {
          ...
          M_predicates.push_back( PlayerPredicate::Ptr( p6 ) );
          M_predicates.push_back( PlayerPredicate::Ptr( p7 ) );
          M_predicates.push_back( PlayerPredicate::Ptr( p8 ) );
      }
...
private:
     ...
     */
    AndPlayerPredicate( const std::vector< PlayerPredicate::Ptr > & predicates )
...
public:
    ...
    */
    bool operator()( const AbstractPlayerObject & p ) const
      {
          const std::vector< PlayerPredicate::Ptr >::const_iterator p_end = M_predicates.end();
          for ( std::vector< PlayerPredicate::Ptr >::const_iterator it = M_predicates.begin();
                it != p_end;
                ++it )
          {
              if ( ! (**it)( p ) )
...
private:
    /*!
      ...
      \param predicates predicates container.
     */
    OrPlayerPredicate( const std::vector< PlayerPredicate::Ptr > & predicates )
        : M_predicates( predicates )
      { }
...
public:
    ...
    */
    bool operator()( const AbstractPlayerObject & p ) const
      {
          const std::vector< PlayerPredicate::Ptr >::const_iterator
              p_end = M_predicates.end();

          for ( std::vector< PlayerPredicate::Ptr >::const_iterator
...
private:
    //! predicate instance
    PlayerPredicate::Ptr M_predicate;
...
public:
    ...
    */
    explicit
    NotPlayerPredicate( PlayerPredicate::Ptr predicate )
        : M_predicate( predicate )
      { }
...
public:
    ...
    */
    ...
    PlayerPredicate * clone() const
      {
          return new ContainsPlayerPredicate( M_geom );
      }
};

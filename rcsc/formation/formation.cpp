...
Formation::create( const std::string & name )
{
    ...
    else if ( name == FormationSSL::NAME ) ptr = FormationSSL::create(2);
	else if ( name == FormationSSL::NAME+'1' ) ptr = FormationSSL::create(1);
    else if ( name == FormationSSL::NAME+'2' ) ptr = FormationSSL::create(2);
    else if ( name == FormationSSL::NAME+'3' ) ptr = FormationSSL::create(3);
    else if ( name == FormationSSL::NAME+'4' ) ptr = FormationSSL::create(4);
	else if ( name == FormationSSL::NAME+'5' ) ptr = FormationSSL::create(5);
    return ptr;
}
